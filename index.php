<?php
	...
	require_once $_SERVER['DOCUMENT_ROOT'] . '/i01/zxc/project/config/connection.php';
	...
	spl_autoload_register(function($class) {
		...
		$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . '/i01/zxc/'. $nameSpace . DIRECTORY_SEPARATOR . $className . '.php';
	...
	$routes = require $_SERVER['DOCUMENT_ROOT'] . '/i01/zxc/project/config/routes.php';
